...
async def draw_rectangle(x1: int, y1: int, x2: int, y2: int) -> dict:
    ...
    try:
        ...
        # Ensure Paint window is active and on top
        win32gui.SetForegroundWindow(paint_window.handle)
        paint_window.set_focus()
        time.sleep(1)  # Increased delay to ensure window is active
...
async def add_text_in_paint(text: str) -> dict:
    ...
    try:
        ...
        canvas.click_input(coords=(500, 400))  # Using more reasonable coordinates
...
async def open_paint() -> dict:
    ...
    try:
        ...
        time.sleep(1)  # Added delay after moving window
        
        # Now maximize the window
        win32gui.ShowWindow(paint_window.handle, win32con.SW_MAXIMIZE)
        time.sleep(2)  # Increased delay after maximizing
